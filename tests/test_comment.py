...
class TestCommentAPI:
    ...
    def test_comments_create(self, user_client, post, user, another_user):
        ...
        data = {}
        response = user_client.post(f'/api/v1/posts/{post.id}/comments/',
                                    data=data)
    ...
    @pytest.mark.django_db(transaction=True)
    def test_comment_patch_current(self, user_client, post, comment_1_post,
                                   comment_2_post):
    ...
    @pytest.mark.django_db(transaction=True)
    def test_comment_delete_current(self, user_client, post, comment_1_post,
                                    comment_2_post):
